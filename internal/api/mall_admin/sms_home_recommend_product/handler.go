...
import (
	...
	"github.com/ChangSZ/mall-go/internal/services/mall_admin/sms_home_recommend_product"
)
...
type handler struct {
	service sms_home_recommend_product.Service
}

func New() Handler {
	return &handler{
		service: sms_home_recommend_product.New(),
	}
}
