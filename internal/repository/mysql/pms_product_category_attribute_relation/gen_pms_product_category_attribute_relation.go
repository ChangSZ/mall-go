...
func (qb *pmsProductCategoryAttributeRelationQueryBuilder) Updates(db *gorm.DB, m map[string]interface{}) (err error) {
...
func (qb *pmsProductCategoryAttributeRelationQueryBuilder) Update(db *gorm.DB, data *PmsProductCategoryAttributeRelation) (cnt int64, err error) {
	db = db.Model(&PmsProductCategoryAttributeRelation{})
...
func (qb *pmsProductCategoryAttributeRelationQueryBuilder) Delete(db *gorm.DB) (err error) {
	for _, where := range qb.where {
		db = db.Where(where.prefix, where.value)
	}

	if err = db.Delete(&PmsProductCategoryAttributeRelation{}).Error; err != nil {
