...
func (qb *pmsSkuStockQueryBuilder) Updates(db *gorm.DB, m map[string]interface{}) (err error) {
...
func (qb *pmsSkuStockQueryBuilder) Update(db *gorm.DB, data *PmsSkuStock) (cnt int64, err error) {
	db = db.Model(&PmsSkuStock{})
...
func (qb *pmsSkuStockQueryBuilder) Delete(db *gorm.DB) (err error) {
	for _, where := range qb.where {
		db = db.Where(where.prefix, where.value)
	}

	if err = db.Delete(&PmsSkuStock{}).Error; err != nil {
