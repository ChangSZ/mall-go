...
func (qb *umsMemberQueryBuilder) Updates(db *gorm.DB, m map[string]interface{}) (err error) {
...
func (qb *umsMemberQueryBuilder) Update(db *gorm.DB, data *UmsMember) (cnt int64, err error) {
	db = db.Model(&UmsMember{})
...
func (qb *umsMemberQueryBuilder) Delete(db *gorm.DB) (err error) {
	for _, where := range qb.where {
		db = db.Where(where.prefix, where.value)
	}

	if err = db.Delete(&UmsMember{}).Error; err != nil {
