...
func (qb *omsOrderReturnApplyQueryBuilder) Updates(db *gorm.DB, m map[string]interface{}) (err error) {
...
func (qb *omsOrderReturnApplyQueryBuilder) Update(db *gorm.DB, data *OmsOrderReturnApply) (cnt int64, err error) {
	db = db.Model(&OmsOrderReturnApply{})
...
func (qb *omsOrderReturnApplyQueryBuilder) Delete(db *gorm.DB) (err error) {
	for _, where := range qb.where {
		db = db.Where(where.prefix, where.value)
	}

	if err = db.Delete(&OmsOrderReturnApply{}).Error; err != nil {
