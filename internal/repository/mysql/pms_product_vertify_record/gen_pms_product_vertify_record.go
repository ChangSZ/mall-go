...
func (qb *pmsProductVertifyRecordQueryBuilder) Updates(db *gorm.DB, m map[string]interface{}) (err error) {
...
func (qb *pmsProductVertifyRecordQueryBuilder) Update(db *gorm.DB, data *PmsProductVertifyRecord) (cnt int64, err error) {
	db = db.Model(&PmsProductVertifyRecord{})
...
func (qb *pmsProductVertifyRecordQueryBuilder) Delete(db *gorm.DB) (err error) {
	for _, where := range qb.where {
		db = db.Where(where.prefix, where.value)
	}

	if err = db.Delete(&PmsProductVertifyRecord{}).Error; err != nil {
