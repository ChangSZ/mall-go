...
func (qb *pmsProductAttributeValueQueryBuilder) Updates(db *gorm.DB, m map[string]interface{}) (int64, error) {
...
func (qb *pmsProductAttributeValueQueryBuilder) Delete(db *gorm.DB) (int64, error) {
	for _, where := range qb.where {
		db = db.Where(where.prefix, where.value)
	}

	ret := db.Delete(&PmsProductAttributeValue{})
	err := ret.Error
	if err != nil {
