...
func (qb *pmsProductQueryBuilder) Updates(db *gorm.DB, m map[string]interface{}) (err error) {
...
func (qb *pmsProductQueryBuilder) Update(db *gorm.DB, data *PmsProduct) (cnt int64, err error) {
	db = db.Model(&PmsProduct{})
...
func (qb *pmsProductQueryBuilder) Delete(db *gorm.DB) (err error) {
	for _, where := range qb.where {
		db = db.Where(where.prefix, where.value)
	}

	if err = db.Delete(&PmsProduct{}).Error; err != nil {
