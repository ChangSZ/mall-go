...
func (qb *pmsProductAttributeQueryBuilder) Updates(db *gorm.DB, m map[string]interface{}) (err error) {
...
func (qb *pmsProductAttributeQueryBuilder) Update(db *gorm.DB, data *PmsProductAttribute) (cnt int64, err error) {
	db = db.Model(&PmsProductAttribute{})
...
func (qb *pmsProductAttributeQueryBuilder) Delete(db *gorm.DB) (err error) {
	for _, where := range qb.where {
		db = db.Where(where.prefix, where.value)
	}

	if err = db.Delete(&PmsProductAttribute{}).Error; err != nil {
