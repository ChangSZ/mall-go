...
func (qb *umsAdminQueryBuilder) Updates(db *gorm.DB, m map[string]interface{}) (err error) {
...
func (qb *umsAdminQueryBuilder) Update(db *gorm.DB, data *UmsAdmin) (cnt int64, err error) {
	db = db.Model(&UmsAdmin{})
...
func (qb *umsAdminQueryBuilder) Delete(db *gorm.DB) (err error) {
	for _, where := range qb.where {
		db = db.Where(where.prefix, where.value)
	}

	if err = db.Delete(&UmsAdmin{}).Error; err != nil {
