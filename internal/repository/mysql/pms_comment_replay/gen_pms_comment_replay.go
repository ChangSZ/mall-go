...
func (qb *pmsCommentReplayQueryBuilder) Updates(db *gorm.DB, m map[string]interface{}) (err error) {
...
func (qb *pmsCommentReplayQueryBuilder) Update(db *gorm.DB, data *PmsCommentReplay) (cnt int64, err error) {
	db = db.Model(&PmsCommentReplay{})
...
func (qb *pmsCommentReplayQueryBuilder) Delete(db *gorm.DB) (err error) {
	for _, where := range qb.where {
		db = db.Where(where.prefix, where.value)
	}

	if err = db.Delete(&PmsCommentReplay{}).Error; err != nil {
