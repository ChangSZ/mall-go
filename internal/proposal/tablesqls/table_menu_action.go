...
func CreateMenuActionTableDataSql() (sql string) {
	...
	sql += "(8, 5, 'POST', '/render/generator/gorm/execute', 'init'),"
	sql += "(9, 6, 'POST', '/render/generator/handler/execute', 'init'),"
	sql += "(10, 8, 'GET', '/render/authorized/add', 'init'),"
	sql += "(11, 8, 'GET', '/render/authorized/api/*', 'init'),"
	...
	sql += "(19, 11, 'GET', '/render/admin/add', 'init'),"
	...
	sql += "(25, 11, 'GET', '/render/admin/action/*', 'init'),"
	sql += "(26, 11, 'GET', '/api/admin/menu/*', 'init'),"
	sql += "(27, 11, 'POST', '/api/admin/menu', 'init'),"
	sql += "(28, 12, 'GET', '/render/admin/menu_action/*', 'init'),"
	...
	sql += "(37, 22, 'POST', '/render/upgrade/execute', 'init'),"
	sql += "(38, 11, 'PATCH', '/api/admin/offline', 'init'),"
	sql += "(39, 12, 'PATCH', '/api/menu/sort', 'init'),"
	sql += "(40, 24, 'GET', '/render/cron/add', 'init'),"
	sql += "(41, 24, 'GET', '/render/cron/edit/*', 'init'),"
