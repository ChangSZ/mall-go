...
func setApiRouter(r *resource) {
	// helper
	helperHandler := helper.New(r.logger)
	...
	// admin
	adminHandler := admin.New(r.logger)
	...
	{
		// authorized
		authorizedHandler := authorized.New(r.logger)
		...
		// cron
		cronHandler := cron.New(r.logger, r.cronServer)
